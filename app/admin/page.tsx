...
export default async function AdminPage() {
  ...
  return <div className="p-5 md:p-8 lg:p-10">
    <div className="flex flex-wrap items-end justify-between gap-4"><div><p className="text-xs font-black uppercase tracking-[.14em] text-primary">Jshop operations</p><h1 className="mt-2 text-4xl font-black tracking-[-.05em]">Good morning, Admin.</h1><p className="mt-2 text-sm text-muted-foreground">Here&apos;s what is happening across the marketplace.</p></div><Button asChild><Link href="/admin/products/new">ADD PRODUCT</Link></Button></div>
