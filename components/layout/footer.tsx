...
export async function Footer() {
  ...
  </div><div className="border-t border-white/10"><div className="shell flex flex-col gap-2 py-5 text-[11px] text-neutral-500 sm:flex-row sm:justify-between"><p>© 2026 Jshop. {t("footer.rights")}</p><p>TUNISIE · TND · {t("checkout.cash")}</p></div></div></footer>;
}
